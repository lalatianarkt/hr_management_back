...
public interface UserRoleRepository extends JpaRepository<UserRole, UserRoleId> {
    ...
    // Utiliser UNIQUEMENT des méthodes JPQL explicites
    // Ne PAS utiliser de méthodes dérivées comme findById_UserId
    ...
    List<UserRole> findByTypeUserId(@Param("typeUserId") Integer typeUserId);
